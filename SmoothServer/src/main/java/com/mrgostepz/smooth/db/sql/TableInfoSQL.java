...
public class TableInfoSQL {
    ...
    public static final String SQL_GET_TABLE_DETAIL_BY_ID = "SELECT * FROM " + TABLE_TABLE_DETAIL + " WHERE " + COL_TABLE_INFO_ID + " = ?;";
    ...
    public static final String SQL_UPDATE_TABLE_DETAIL = "UPDATE " + TABLE_TABLE_DETAIL + " SET "
            ...
            + COL_NAME + " = ? WHERE "
            + COL_TABLE_INFO_ID + " = ?;";
    public static final String SQL_DELETE_TABLE_DETAIL = "DELETE FROM " + TABLE_TABLE_DETAIL + " WHERE " + COL_TABLE_INFO_ID + " = ?;";
}
