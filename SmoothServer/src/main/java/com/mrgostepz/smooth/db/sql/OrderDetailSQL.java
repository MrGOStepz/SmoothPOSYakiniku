...
public class OrderDetailSQL {
    ...
    public static final String SQL_GET_ORDER_DETAIL_BY_ID = "SELECT * FROM " + TABLE_ORDER_DETAIL + " WHERE " + COL_ORDER_ID +" = ?;";
    ...
    public static final String SQL_UPDATE_ORDER_DETAIL = "UPDATE " + TABLE_ORDER_DETAIL + " SET "
            ...
            + COL_ORDER_ID + " = ?;";
    public static final String SQL_DELETE_ORDER_DETAIL = "DELETE FROM " + TABLE_ORDER_DETAIL + " WHERE " + COL_ORDER_ID + " = ?;";
}
